...
class Kalman2D:
    def __init__(self, process_var=1e-4, measurement_var=1e-1):
...
def fuse_distance_measurements(step_distance, position_distance, confidence_step, confidence_position):
    """
    ...
    fused_distance = (step_distance * norm_confidence_step)*0 + (position_distance * norm_confidence_position)
    ...
    try:
        ...
        def update_csv_thread():
            ...
            while True:
                ...
                csv_update_event.wait(timeout=0.5)
